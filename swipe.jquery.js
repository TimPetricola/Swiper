...
(function($, window) {
  ...
  Swiper = (function() {
    ...
    function Swiper(el, options) {
      ...
      $('img', this.$el).css('user-select', 'none');
      this._init();
      this._start();
    ...
    Swiper.prototype._init = function() {
      ...
      this._slide(this.index, 0);
      return this.$container.css('visibility', 'visible');
    };

    Swiper.prototype._slide = function(index, duration) {
      if (duration == null) {
    ...
    Swiper.prototype._onTouchMove = function(e) {
      var firstSlidingLeft, lastSlidingRight, resistance;
      e = e.originalEvent;
      ...
      firstSlidingLeft = !this.index && this.deltaX > 0;
      lastSlidingRight = this.index === this.$slides.length - 1 && this.deltaX < 0;
      resistance = firstSlidingLeft || lastSlidingRight ? Math.abs(this.deltaX) / this.width + 1 : 1;
      this.deltaX = this.deltaX / resistance;
    ...
    Swiper.prototype._onTouchEnd = function(e) {
      ...
      if (!this.isScrolling) {
        ...
        this._slide(this.index + val, this.options.speed);
      }
      return e.stopPropagation();
    };
    ...
    Swiper.prototype.prev = function(delay) {
      ...
      clearTimeout(this.interval);
      if (this.index) {
        return this._slide(this.index - 1, this.options.speed);
      }
    };
    ...
    Swiper.prototype.next = function(delay) {
      ...
      if (this.index < this.$slides.length - 1) {
        ...
        return this._slide(0, this.options.speed);
      }
    };
